<nav>
            ...
            <div class="drop-down-content" id="left-drop">
                ...
                <?php
                      ...
                      <?php }
                ?>
                <div class="drop-but" id="drop-but-6"><a href="profile.php">Profiel</a></div>
                <?php 
            ...
            <div class="drop-down-content" id="user-drop"><div><a href="profile.php">Profiel</a></div></div>
            <?php if (isset($_SESSION["authenticated"]) && (($_SESSION['user-inf']['type'] == 'author') || ($_SESSION['user-inf']['type'] == 'admin'))) {
